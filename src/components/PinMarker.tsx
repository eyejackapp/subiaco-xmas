...
export const PinMarker = ({ position, imageUrl, scale }: PinMarkerProps) => {
    return (
        <div
            ...
            className="absolute origin-bottom top-0 left-0 w-[50px] h-[50px] z-[10] aspect-square rounded-full after:content-[''] after:absolute after:-z-[10] after:top-full after:left-1/2 after:-translate-x-1/2 after:-translate-y-[9px] after:border-[20px] after:border-solid after:border-[#C4A056_transparent_transparent_transparent]"
        >
